      ...
      <ul>
        ...
        <li>
          <p>
            ...
            &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to GymPool.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to GymPool, accessible from{" "}
            <a href="https://gympool.nodm.app" rel="external nofollow noopener" target="_blank">
              https://gympool.nodm.app
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        ...
        <li>
          ...
          <a
            ...
            target="_blank"
          >
            disable-local-shared-objects-flash
          </a>
        </li>
        <li>
